...
enum GlossarySource: String, Codable, CaseIterable {
...
final class GlossaryEntry {
    ...
    var source: GlossarySource {
        get { GlossarySource(rawValue: sourceRaw) ?? .userClarification }
    ...
    init(
        ...
        unclearTerms: [String],
        explanation: String,
        region: String = "Québec",
        source: GlossarySource = .userClarification,
